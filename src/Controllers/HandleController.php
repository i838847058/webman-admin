...
namespace Shx\Admin\Controllers;

use Shx\Admin\Actions\Action;
use Shx\Admin\Actions\GridAction;
use Shx\Admin\Actions\Response;
use Shx\Admin\Actions\RowAction;
use Shx\Admin\Widgets\Form;
use Exception;
...
class HandleController extends Controller
{
    ...
    public function handleSelectable(Request $request)
    {
        ...
        if (class_exists($class)) {
            /** @var \Shx\Admin\Grid\Selectable $selectable */
