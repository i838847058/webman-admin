...
namespace Shx\Admin\Form;

use Shx\Admin\Admin;
use Shx\Admin\Form;
use Shx\Admin\Widgets\Form as WidgetForm;
...
class NestedForm
{
    ...
    /**
     * @var \Shx\Admin\Form|\Shx\Admin\Widgets\Form
     */
    protected $form;
    ...
    protected function prepareRecord($record)
    {
        ...
        foreach ($this->fields as $field) {
            ...
            if (($field instanceof \Shx\Admin\Form\Field\Hidden) || $value != $field->original()) {
                if (is_array($columns)) {
